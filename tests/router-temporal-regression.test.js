...

{
  ...
  const patchCalls = (editSource.match(/await patchOnce\(/g) || []).length;
  assert.ok(patchCalls >= 1 && patchCalls <= 2, 'una edicion intenta el parche (recorte) y a lo sumo un reintento a pagina completa');
